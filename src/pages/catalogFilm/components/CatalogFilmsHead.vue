<template>
  <div class="Schedule__head">
    ...
    <button
      @click="subscribeAccept"
      style="background: none; border: none; cursor: pointer"
      class="Schedule__addres"
    >
...
<script>
export default {
  props: ["catalogFilmsMonths", "ScheduleAddres", "currentMonth"],
  data() {
    return {
      ScheduleAddresAccept: false,
    };
  },
  methods: {
    subscribeAccept() {
      this.ScheduleAddresAccept = !this.ScheduleAddresAccept;
      alert(this.ScheduleAddres.text);
    },
    handelMonth(by) {
      this.$emit("chooseMonth", by);
    },
  },
};
</script>
...
.Schedule__head {
  ...
  .Schedule__title {
    @include font(vw(30), bold, vw(50), $greyBlue50);
  }
  .Schedule__addres {
    align-items: center;
    justify-content: center;
    display: flex;
    @include font(vw(13), bold, vw(25), $greyBlue50);
    &:hover {
      @include font(vw(13), bold, vw(25), darken($greyBlue50, 5%));
    }
    img {
      margin-right: vw(15);
    }
...
@media screen and (max-width: 192px) {
  .Schedule__head {
    ...
    .Schedule__month-nav {
      .Schedule__month-list {
        ...
        .Schedule__month-item {
          ...
          cursor: pointer;
          span {
            @include font(vmin(22), bolder, vmin(20), $greyBlue60);
            transition: 0.5s;
          }
        }
      }
    ...
    .Schedule__title {
      margin: 0;
      @include font(vmin(33), bold, vmin(50), $greyBlue50);
    }
    .Schedule__addres {
      margin-top: vmin(15);
      align-items: center;
      justify-content: center;
      display: flex;
      @include font(vmin(22), bolder, vmin(25), $greyBlue50);
      &:hover {
        @include font(vmin(22), bold, vmin(25), darken($greyBlue50, 5%));
      }
      img {
        margin-right: vmin(15);
      }
...
@media screen and (max-width: 173px) {
  .Schedule__head {
    ...
    .Schedule__month-nav {
      .Schedule__month-list {
        ...
        .Schedule__month-item {
          ...
          cursor: pointer;
          span {
            @include font(vmin(24), bolder, vmin(20), $greyBlue60);
            transition: 0.5s;
          }
        }
      }
    ...
    .Schedule__addres {
      ...
      justify-content: center;
      display: flex;
      @include font(vmin(24), bolder, vmin(25), $greyBlue50);
      &:hover {
        @include font(vmin(24), bold, vmin(25), darken($greyBlue50, 5%));
      }
      img {
        margin-right: vmin(15);
      }
